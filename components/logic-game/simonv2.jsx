    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-gradient-to-b from-violet-300 to-violet-400">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            {birds.map((name, birdIndex) => (
              <button
                ...
                className={`
                  relative h-32 rounded-lg flex flex-col items-center justify-center transition-all duration-200 ease-in-out
      ...
      <Dialog open={isStartDialogOpen} onOpenChange={setIsStartDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button className="bg-violet-700 hover:bg-violet-600" onClick={() => setIsStartDialogOpen(false)}>
              Comenzar
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-lg font-bold text-[#DA2B24]">¡Perdiste! 😔</DialogTitle>
      ...
      <Dialog open={isWinDialogOpen} onOpenChange={setIsWinDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-lg font-bold text-[#FDCA32]">¡Felicidades! 🎉</DialogTitle>
            <DialogDescription className="text-black/80 font-semibold text-md">
